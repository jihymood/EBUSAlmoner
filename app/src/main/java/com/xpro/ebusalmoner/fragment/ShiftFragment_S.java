...
import com.xpro.ebusalmoner.activity.BreakdownActivity_S;
 ...
 * @author huangjh
 */
public class ShiftFragment_S extends BaseFragment implements
        ...
        public void doHandle(Message msg) {
            ...
            switch (msg.what) {
                case Constants.GET_TASK_SUCCESS:
                    dataList = (List<TrailerTaskData_S>) msg.obj;
                    Log.e("----", dataList.get(0).getHitchLatitude());
                    // getData(dataList);
                    break;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_shift_s, null);
...
//        getData();
    ...
    public void getServerData() {
        ...
        params.addBodyParameter("messageType", "task");
        x.http().get(params, new CommonCallback<String>() {
            @Override
            public void onSuccess(String result) {
                // TODO Auto-generated method stub
                root = JSON.parseObject(result, TrailerTaskRoot_S.class);
                body = root.getBody();
//                dataList = body.getData();
    ...
    // private void getData(List<TrailerTaskData_S> dataList) {
//    private void getData() {
//        TrailerTaskRoot_S root4 = JSON.parseObject(json,
//                TrailerTaskRoot_S.class);
//        Log.e("ShiftFragment_S", "json:"+json);
//        dataList = root4.getBody().getData();
//        if (dataList != null && dataList.size() > 0) {
//            for (int i = 0; i < dataList.size(); i++) {
//                TrailerTaskData_S data = dataList.get(i);
//                String hLat = data.getHitchLatitude();
//                String hLng = data.getHitchLongitude();
//                String tLat = data.getTrailerLatitude();
//                String tLng = data.getTrailerLongitude();
//                lineStr = data.getLine();// 路线
//                numberStr = data.getNumber();// 自编号
...
//                cenpt2 = new LatLng(Double.parseDouble(tLat),
...
//    }
    ...
    public void initView() {
        ...
        linear2 = (RelativeLayout) view.findViewById(R.id.linear2);
        mMapView = (MapView) view.findViewById(R.id.mapView);
        line = (TextView) view.findViewById(R.id.line);
        lineNumber = (TextView) view.findViewById(R.id.lineNumber);
        driverName = (TextView) view.findViewById(R.id.driverName);
        lineTime = (TextView) view.findViewById(R.id.lineTime);
        location = (TextView) view.findViewById(R.id.location);
        button = (Button) view.findViewById(R.id.button);
        history = (Button) view.findViewById(R.id.history);
        button_false = (Button) view.findViewById(R.id.button_false);
        driverTel = (ImageView) view.findViewById(R.id.driverTel);
        traffic_focus = (Button) view.findViewById(R.id.traffic_focus);
        traffic_blur = (Button) view.findViewById(R.id.traffic_blur);
    ...
    OnGetRoutePlanResultListener listener = new OnGetRoutePlanResultListener() {
        ...
        public void onGetDrivingRouteResult(DrivingRouteResult result) {
            // 获取驾车线路规划结果
            if (result == null) {
                Toast.makeText(getActivity(), "抱歉，未找到导航结果", Toast.LENGTH_SHORT)
                        .show();
            }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.back:
                getActivity().finish();
                break;
            case R.id.button:// 故障详情
                Intent intent = new Intent(getActivity(), BreakdownActivity_S.class);
            ...
            case R.id.history:// 历史
                startActivity(new Intent(getActivity(), com.xpro.ebusalmoner.activity.HistoryActivity.class));
                break;
            case R.id.driverTel:
