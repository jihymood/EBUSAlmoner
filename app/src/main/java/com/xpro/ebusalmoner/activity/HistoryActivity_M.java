...
public class HistoryActivity_M extends BaseActivity implements OnClickListener,
    ...
    private String dateStr, trailerCode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler = new MyHandler(HistoryActivity_M.this);
        logic = new TaskLogic(handler, HistoryActivity_M.this);
        HistoryManagerEntity entity = new HistoryManagerEntity();
        entity.setState("2");
        entity.setDetailType("1");
        entity.setHitchTime(dateStr);
        entity.setTrailerCode(trailerCode);
    ...
    public void onListener() {
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent intent = new Intent(HistoryActivity_M.this,
        ...
        CommonDatePickerDialog dialog = new CommonDatePickerDialog(this,
            ...
            public void onDateSet(DatePicker view, int year, int month,
                ...
                if (finishRadio.isChecked()) {
                    ...
                    entity1.setTrailerCode(trailerCode);
                    ...
                    entity2.setTrailerCode(trailerCode);
        ...
        public void doHandle(Message msg) {
            ...
            switch (msg.what) {
                ...
                case Constants.MANAGER_COMPLETE_FAIL:
                    ToastUtils.showToast(HistoryActivity_M.this, "" + msg.obj);
                    break;
                default:
                    break;
            }
